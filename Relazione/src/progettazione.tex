...
\subsubsection{Aiuti alla navigazione}
 ...
 \begin{itemize}
     ...
     \item \textbf{Placeholder nella barra di ricerca:} si è scelto di inserire un placeholder via Javascript nella barra di ricerca per garantire informazioni aggiuntive sull'effettivo scopo di tale strumento, oltre ad un tag label, correttamente nascosto in modo che sia visibile solamente allo screen reader.
 \end{itemize}
