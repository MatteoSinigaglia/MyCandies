...
\subsubsection{Aiuti alla navigazione}
 ...
 \begin{itemize}
     ...
     \item \textbf{Label nella barra di ricerca:} si è scelto di inserire una label nella barra di ricerca (opportunamente nascosta tramite CSS) e visibile solo allo screen reader per garantire informazioni aggiuntive sull'effettivo scopo di tale componente. In tal modo si evita di utilizzare Javascript, risolvendo di fatto le problematiche legate all'eventuale inserimento di un placeholder.
