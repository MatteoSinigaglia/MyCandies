...
\subsubsection{Aiuti alla navigazione}
 ...
 \begin{itemize}
     ...
     \item \textbf{Placeholder nella barra di ricerca:} si è scelto di inserire un placeholder nella barra di ricerca per garantire informazioni aggiuntive sull'effettivo scopo di tale strumento, altrimenti lo screen reader lo avrebbe identificato come semplice campo di digitazione, senza  attribuirgli una reale funzione.
     \item 
 \end{itemize}
