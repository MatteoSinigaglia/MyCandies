...
(9,5,'Crystal Meth - confezione da 5 grammi','Con il nome"Crystal meth" ci si riferisce alla forma più pura della metanfetamina, ovvero cristalli solitamente limpidi di D-metanfetamina cloridrato . Spesso viene fumata o iniettata con effetti di gran lunga superiori alle altre vie di assunzione. L''effetto molto lungo (6-12 ore) è una delle caratteristiche principali di questo tipo di sostanze. Il Crystal Meth è stato particolarmente reso celebre dalla serie TV Breaking Bad.',600,40);
...
INSERT INTO `Images` (`id`, `img_path`) VALUES
    (1,'../img/products/xanax.jpg'),
    (2,'../img/products/marijuana.jpg'),
    (3,'../img/products/crack.jpg'),
    (4,'../img/products/lsd.jpeg'),
    (5,'../img/products/cocaina.jpg'),
    (6,'../img/products/eroina.jpg'),
    (7,'../img/products/makatussin.jpg'),
    (8,'../img/products/ecstasy.jpg'),
    (9,'../img/products/crystal_meth.jpg');
