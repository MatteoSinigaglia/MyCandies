...
(2, 2, "Taurina mou", "Le caramelle mou si ottengono sciogliendo nel latte freddo un pizzico di sale per poi portarlo ad ebollizione mescolando frequentemente fino a raggiungere un composto tipo marmellata. La nostra versione prevede l'aggiunta di grosse quantità di taurina, la quale permette, in seguito all'assunzione, di muoversi a super velocità. <span xml:lang='en'>Grant Gustin</span>, attore che interpreta <span xml:lang='en'>Barry Allen</span> nella famosa serie <span xml:lang='en'>The Flash</span>, assume regolarmente 'Taurina mou' prima delle scena d'azione, rendendo così inutile il ruolo di controfigure ed effetti speciali.", 10, 300),

(3, 5, "Ciucci cola ionizzate", "Le nostre ciucci cola sono un perfetto spuntino in situazioni di stress o stanchezza. Il contenuto di gas ionizzato permette infatti di aumentare notevolmente la concentrazione del consumatore. Il prezzo economico è giustificato dalla durata dell'effetto conferito dopo il consumo, limitato a 23 minuti. Non ci sono controindicazioni, pertanto è possibile assumere una quantità illimitata di ciucci cola ionizzate.", 23.00, 450),

(4, 4, "Anguria leggera", "Queste caramelle a forma di anguria hanno inaspettatamente il gusto di anguria, o meglio un leggero gusto di anguria. Il loro elevato contenuto di elio renderà difficile assumerle una volta aperto il pacchetto. Anche l'assunzione potrebbe non risultare così semplice! Una volta assunta la giusta quantità di caramelle sarete pieni di elio e pronti a prendere il volo per qualsiasi direzione! Le dosi possono variare in relazione al peso del consumatore.", 150.00, 100),

(5, 5, "Coccodrionizzati", "Il coccodrillo più dolce di tutti con la pancia di <span xml:lang='en'>marshmallow</span> delizia tutte le generazioni di buongustai dal 2010. Con la sua tenera consistenza e la sua forma divertente il coccodrillo gommoso viene assunto per aiutarci in momenti un pò meno divertenti. Il contenuto di gas ionizzato permette di aumentare la concentrazione di chi lo assume, rendendolo un prodotto utile per studenti, lavoratori e chi ha bisogno di una spinta extra dopo una sbornia.", 98.00, 2000),
