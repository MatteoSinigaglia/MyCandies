...
(4, 4, "Anguria leggera", "Queste caramelle a forma di anguria hanno inaspettatamente il gusto di anguria, o meglio un leggero gusto di anguria. Il loro elevento contenuto di elio renderà difficile assumerle una volta aperto il pacchetto. Anche l'assunzione potrebbe non risultare così semplice! Una volta assunta la giusta quantità di caramelle sarete pieni di elio e pronti a prendere il volo per qualsiasi direzione! Le dosi possono variare in relazione al peso del consumatore.", 150.00, 100),
