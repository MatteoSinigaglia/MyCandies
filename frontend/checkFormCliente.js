...
var form_registrazione = {
    "email": ["Inserisci e-mail", /^([a-z0-9_\.-]+)@([\da-z\.-]+)\.([a-z\.]{2,6})$/ , "La mail inserita non è corretta"],
    "password": ["Inserisci password", /\w{5,20}/,"La password inserita non è corretta"],
    "confirmPassword": ["Inserisci nuovamente la password", /\w{5,20}/,"La password non corrisponde"],
